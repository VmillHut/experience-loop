...
Recorded run: [2026-08-06 mode experience evaluation](2026-08-06-mode-experience-report.md).
...
`auto` after one natural-language profile sentence covering a responsibility,
domain, explanation preference, or delivery context. Do not ask either user to
...
3. elapsed time, turns, required user answers, and avoidable interruptions;
...
Do not reward question count, explanation length, ledger events, or XP. Treat
